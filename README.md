...
| 🧪 In Development | [`todo`](./skills/todo) | /todo \| /todo <text> \| /todo done <id> \| /todo setup — hybrid local + GitHub Issues/Jira todo list, routed by project. | @jarellano01 | v2: YAML store, no dual-format support — see CHANGELOG.md. GitHub Issues and Jira backends ship; Linear can be added later as a new file in todo-instructions.examples/. |
<!-- SKILLS-TABLE:END -->
